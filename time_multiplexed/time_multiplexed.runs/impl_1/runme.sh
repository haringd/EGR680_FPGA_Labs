...
HD_PWD='C:/FPGA_EGR680/time_multiplexed/time_multiplexed.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log time_multiplexed_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source time_multiplexed_top.tcl -notrace
