...
HD_PWD='C:/FPGA_EGR680/time_multiplexed/time_multiplexed.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log time_multiplexed_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source time_multiplexed_top.tcl
