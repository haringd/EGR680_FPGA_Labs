...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"../../../../UART_app.srcs/sources_1/bd/system/ipshared/7e3a/hdl" \
       +incdir+"../../../../UART_app.srcs/sources_1/bd/system/ipshared/2ad9/hdl" \
       +incdir+"../../../../UART_app.srcs/sources_1/bd/system/ipshared/39ca/hdl/verilog" \
       +incdir+"../../../../UART_app.srcs/sources_1/bd/system/ipshared/6eb1/hdl" \
       +incdir+"../../../../UART_app.srcs/sources_1/bd/system/ipshared/1d61/hdl"
}
