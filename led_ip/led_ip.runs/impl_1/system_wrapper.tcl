...
set rc [catch {
  ...
  set_property webtalk.parent_dir C:/FPGA_EGR680/led_ip/led_ip.cache/wt [current_project]
  set_property parent.project_path C:/FPGA_EGR680/led_ip/led_ip.xpr [current_project]
  set_property ip_repo_paths C:/FPGA_EGR680/ip_repo [current_project]
  set_property ip_output_repo C:/FPGA_EGR680/led_ip/led_ip.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_MEMORY} [current_project]
  add_files -quiet C:/FPGA_EGR680/led_ip/led_ip.runs/synth_1/system_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -suppress
  set_param project.isImplRun true
  add_files C:/FPGA_EGR680/led_ip/led_ip.srcs/sources_1/bd/system/system.bd
  set_property is_locked true [get_files C:/FPGA_EGR680/led_ip/led_ip.srcs/sources_1/bd/system/system.bd]
  set_param project.isImplRun false
  read_xdc C:/FPGA_EGR680/led_ip/led_ip.srcs/constrs_1/new/led_ip_const.xdc
  set_param project.isImplRun true
