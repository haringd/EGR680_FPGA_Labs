...
HD_PWD='C:/FPGA_EGR680/VENDMACH/VENDMACH.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vendmach_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vendmach_top.tcl
