...
HD_PWD='C:/FPGA_EGR680/VENDMACH/VENDMACH.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vendmach_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vendmach_top.tcl -notrace
